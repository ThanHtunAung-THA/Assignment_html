      ...
      <div class="col-md-6">
        <div class="card mb-4">
          <div class="card-body">
            ...
            <p class="card-text">A brief summary of the blog post content. This can be an introduction or a few interesting points to entice readers to click and read more.</p>
